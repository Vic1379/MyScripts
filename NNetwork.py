    ...
    def train(self, x, y):
        for i in range(len(x)):
            ...
            if res != y[i]:
                ...
                dl1_w = x[i]
                self.w4 = [
                    self.w4[0]-de_p_dp_4*d4_w4[0]*self.rate,
                    self.w4[1]-de_p_dp_4*d4_w4[1]*self.rate,
                    self.w4[2]-de_p_dp_4*d4_w4[2]*self.rate
                ]
                self.b4 = self.b4-de_p_dp_4*self.rate
                self.w3 = [
                    self.w3[0]-de_p_dp_4*d4_3*dl1_w[0]*self.rate,
                    self.w3[1]-de_p_dp_4*d4_3*dl1_w[1]*self.rate,
                    self.w3[2]-de_p_dp_4*d4_3*dl1_w[2]*self.rate
                ]
                self.b3 = self.b3-de_p_dp_4*d4_3*self.rate
                self.w2 = [
                    self.w2[0]-de_p_dp_4*d4_2*dl1_w[0]*self.rate,
                    self.w2[1]-de_p_dp_4*d4_2*dl1_w[1]*self.rate,
                    self.w2[2]-de_p_dp_4*d4_2*dl1_w[2]*self.rate
                ]
                self.b2 = self.b2-de_p_dp_4*d4_2*self.rate
                self.w1 = [
                    self.w1[0]-de_p_dp_4*d4_1*dl1_w[0]*self.rate,
                    self.w1[1]-de_p_dp_4*d4_1*dl1_w[1]*self.rate,
                    self.w1[2]-de_p_dp_4*d4_1*dl1_w[2]*self.rate
                ]
                self.b1 = self.b1-de_p_dp_4*d4_1*self.rate
